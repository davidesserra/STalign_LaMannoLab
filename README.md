...
## Installation & Import
To start using the notebooks in the different folders you must firstly install STalign with: 'pip install --upgrade "git+https://github.com/JEFworks-Lab/STalign.git"'
